...
public class SimpleRESTService {
	...
	@Metered(name = "get-property", unit = MetricUnits.MINUTES, description = "Metrics to monitor frequency of getPropertyJSON.", absolute = true)
	...
	@Timed(name = "hello-time-xml", absolute = true)
