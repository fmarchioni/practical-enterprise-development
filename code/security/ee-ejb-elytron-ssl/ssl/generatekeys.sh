...
keytool -genkey -v -alias jbossalias -keyalg RSA -keysize 2048 -keystore server.keystore -validity 3650 -keypass 123456 -storepass 123456 -dname "cn=Server Administrator,o=Acme,c=GB" 
...
keytool -genkey -v -alias clientalias -keyalg RSA -keysize 2048 -keystore client.keystore -validity 3650 -keypass abcdef -storepass abcdef -dname "cn=Server Administrator,o=Acme,c=GB" 
